...
from src.model import buil_random_search
...
def main():
    ...
    check_required_columns(df, num_cols + cat_cols + [target])
    ...
    search  = buil_random_search(num_cols=num_cols, cat_cols=cat_cols)
    ...
    save_model(best_model, "models/titanic_model_tuned.joblib")
    print("Saved: models/titanic_model_tuned.joblib")
